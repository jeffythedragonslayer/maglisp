...
(defun list-manapool    () (format t "~a~%" (get-player-manapool *active-player*))) 
(defun list-life        () (format t "~a~%" (get-player-life *active-player*)))
...
(defun free-mana ()     (set-player-manapool *active-player* (+ 1 (get-player-manapool *active-player*)))) 
(defun pay-mana  (cost) (set-player-manapool *active-player* (- (get-player-manapool *active-player*) cost)))
...
(defun get-priority (player)
	...
	(loop   (with-color 'red (format t "~a priority-> " (get-player-name player)))
                (finish-output nil)
                (let1 a (read-line)
                        (cond ((equalp a "concede")          (progn (format t "conceding~%") (concede player) (return-from get-priority nil)))
                              ...
                              ((string-begins-with a "cast")   (cast-card       (string-trim-first-n a 5))    (return-from get-priority t))
                              ((string-begins-with a "play")   (play-card       (string-trim-first-n a 5))    (return-from get-priority t))
                              ((string-begins-with a "desc")   (describe-card   (string-trim-first-n a 5))    (return-from get-priority t))
                              ((string-begins-with a "tap")    (tap-card        (string-trim-first-n a 4))    (return-from get-priority t))
                              ((string-begins-with a "untap")  (untap-card      (string-trim-first-n a 6))    (return-from get-priority t))
