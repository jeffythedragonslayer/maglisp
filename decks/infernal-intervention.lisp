...
(defparameter *gargoyle-sentinel*
        (make-card :types '(creature)
...
(defparameter *indulgent-tormentor*
        (make-card :types '(creature)
...
(defparameter *infernal-intervention*
        '((13 +mountain+)
          (13 +swamp+)
          (3  *typhoid-Rats*) 
          (2  *carrion-Crow*)
