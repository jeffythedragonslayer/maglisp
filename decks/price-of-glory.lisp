...
(defparameter *kinsbaile-skirmisher*
        (make-card :types '(creature)
...
(defparameter *geist-of-the-moors*
        (make-card :types '(creature)
...
(defparameter *tireless-missionaries*
        (make-card :types '(creature)
...
(defparameter *shadowcloak-vampire*
        (make-card :types '(creature)
...
(defparameter *resolute-archangel*
        (make-card :types '(creature)
                   :name "Resolute Archangle"
                   :cmc 7
                   :subtype 'angel
                   :static-abilities '(flying)
...
(defparameter *solemn-offering*
        (make-card :types '(sorcery)
                   :name "Solemn Offering"
                   :cmc 3
                   :text "Destroy target artifact or enchantment. You gain 4 life."
                   :flavor "\"You will be reimbursed for your donation.\" \"The reimbursement is spiritual.\" —Temple signs"))

(defparameter *mass-calcify*
        (make-card :types '(sorcery)
                   :name "Mass Calcify"
                   :cmc 7
...
(defparameter *staff-of-the-death-magus*
        (make-card :types '(artifact)
...
(defparameter *staff-of-the-sun-magus*
        (make-card :types '(artifact)
...
(defparameter *first-response*
        (make-card :types '(enchantment)
                   :name "First Response"
                   :cmc 4
