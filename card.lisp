...
(defclass card (mtg-object)
        ((name                :initarg :name                :accessor name)
         ...
         (artist              :initarg :artist              :accessor artis)
...
(defgeneric print-card (card)
         (:documentation "prints a card"))

(defmethod print-card ((card card))
  (format t "Name:      ~a~%" (name      card))
  (format t "Subtype:   ~a~%" (subtype   card))
  (format t "CMC:       ~a~%" (cmc       card))
  (format t "Power:     ~a~%" (power     card))
  (format t "Toughness: ~a~%" (toughness card))
  (format t "Flavor:    ~a~%" (flavor    card)))
...
(defclass player ()
  ((name :initarg :name :accessor name)
   ...
   (library :initform (make-instance 'library) :accessor library)
